        ...
        <Layout>
            <div className="grid h-full w-full grid-flow-col grid-rows-2">
                <div className="grid justify-self-center">
                    <div
                        className="place-self-center p-5 rounded-2xl border border-black shadow-lg shadow-black bg-lime-700 ">
                ...
                <div className="grid auto-rows-max grid-cols-2 self-end">
                    ...
                    <div
                        className="grid auto-rows-max grid-cols-2 rounded-2xl border border-black shadow-lg shadow-black m-3 p-5 bg-sky-500">
                        <button
